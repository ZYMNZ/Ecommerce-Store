...
//            $user->getPhoneNumber() === 'NULL' && $user->setPhoneNumber('None');
            ...
            <td><button><a href='/?controller=user&action=editBuyer&id=$id'>Edit...</a></button></td>";
           <td><button type='button' data-toggle='modal' data-target='#myModal'>Delete...</button></td></tr>";
